...
Api.git.clear_clipboard = wrap(function() require("nvim-tree.actions.git").clipboard:clear() end)
Api.git.print_clipboard = wrap(function() return require("nvim-tree.actions.git").clipboard:print() end)
